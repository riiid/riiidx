...
export type Type = $.inside.Explanation;

export function getDefaultValue(): $.inside.Explanation {
  return {
    id: "",
    tagIds: [],
    body: undefined,
...
export function createValue(partialValue: Partial<$.inside.Explanation>): $.inside.Explanation {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.inside.Explanation): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.inside.Explanation {
...
export function encodeBinary(value: $.inside.Explanation): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.inside.Explanation {
  const result = getDefaultValue();
