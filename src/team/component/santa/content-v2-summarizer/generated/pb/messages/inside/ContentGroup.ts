...
export type Type = $.inside.ContentGroup;

export function getDefaultValue(): $.inside.ContentGroup {
  return {
    id: "",
    displayName: "",
...
export function createValue(partialValue: Partial<$.inside.ContentGroup>): $.inside.ContentGroup {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.inside.ContentGroup): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.inside.ContentGroup {
...
export function encodeBinary(value: $.inside.ContentGroup): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.inside.ContentGroup {
  const result = getDefaultValue();
