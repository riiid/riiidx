...
export declare namespace $.inside {
  export interface QuestionSolving {
    /** @deprecated */
    headers: Header[];
    passages: Passage[];
    questions: Question[];
...
export type Type = $.inside.QuestionSolving;

export function getDefaultValue(): $.inside.QuestionSolving {
  return {
    headers: [],
    passages: [],
    questions: [],
...
export function createValue(partialValue: Partial<$.inside.QuestionSolving>): $.inside.QuestionSolving {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.inside.QuestionSolving): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.inside.QuestionSolving {
...
export function encodeBinary(value: $.inside.QuestionSolving): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.inside.QuestionSolving {
  const result = getDefaultValue();
