...
export type Type = $.google.protobuf.Timestamp;

export function getDefaultValue(): $.google.protobuf.Timestamp {
  return {
    seconds: "0",
    nanos: 0,
  };
...
export function createValue(partialValue: Partial<$.google.protobuf.Timestamp>): $.google.protobuf.Timestamp {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.google.protobuf.Timestamp): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.google.protobuf.Timestamp {
...
export function encodeBinary(value: $.google.protobuf.Timestamp): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.google.protobuf.Timestamp {
  const result = getDefaultValue();
